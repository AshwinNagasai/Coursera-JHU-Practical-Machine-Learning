...
```   
The accuracy obtained for the Gradient Boosted Trees model is`r Gbm_accuracy` and the out of sample error rate is `r Gbm_outsamperror` 
...
Based on the results observed, the optimal model is the Random Forests model with accuracy of `r RF_accuracy` and the out of sample error rate of `r RF_outsamperror` . The Gradient Tree with Boosting model comes second best with accuracy of `r Gbm_accuracy` and the out of sample error rate of `r Gbm_outsamperror`. 
